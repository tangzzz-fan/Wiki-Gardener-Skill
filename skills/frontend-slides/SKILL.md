...
description: Create stunning, animation-rich HTML presentations from scratch or by converting PowerPoint files. Use when the user wants to build a presentation, convert a PPT/PPTX to web, create slides for a talk/pitch, or ask for HTML 演示 / PPT. Helps non-designers discover their aesthetic through visual exploration rather than abstract choices.
---
...
## Vault contract (this skills pack)

1. Do **not** write HTML decks into vault `20_领域/`.
2. Default output directory: vault (or workspace) **`90_export/`**, unless the user names another path.
3. Source material may come from notes or `10_inbox/`; this skill only presents — it does not decide absorb/placement (`wiki-gardener`) or factual review (`domain-expert`).
4. No emoji in agent-facing copy for this pack; use text labels like `[警告]`.
